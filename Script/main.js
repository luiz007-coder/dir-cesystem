const SUPABASE_URL = 'https://adozejfhxwtbyuczvzyc.supabase.co';
        ...
        function iniciarRealtime() {
            ...
            ws.onmessage = (event) => {
                ...
                if (data.payload && data.payload.record) {
                    ...
                    } else if (data.topic === 'realtime:usuarios') {
                        carregarMembros();
                    }
                }
            };
        ...
        async function verificarAtualizacoesEmTempoReal() {
            try {
                ...
                if (novasAtividades.length > atividades.length || JSON.stringify(novasAtividades) !== JSON.stringify(atividades)) {
